...
model_chances = model(X_test * lr.coef_ + lr.intercept_).ravel()

plt.plot(X_test, model_chances, color= 'red', linewidth=3)
plt.axhline(y=0, color = 'k',linstyle = '-')
plt.axhline(y=1, color='k',linestyle='-')
plt.axhline(y=0.5, color='b', linestyle='--')

#do hit and trial by changing value of X_test
